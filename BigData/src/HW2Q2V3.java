...
public class HW2Q2V3 {
	...
	public static class MaleUsersRatingsJoinReducer extends
		...
		public void reduce(Text key, Iterable<Text> values, Context context)
			...
			for (Text val : values) {
				...
				/*
				 * if (val.toString().startsWith("M")) { maleUserList.add(new
				 * Text(val.toString().substring(1)));
				 * 
				 * } else
				 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			job1.setJarByClass(HW2Q2V3.class);
			...
			if (completionStatus) {
				...
				job2.setJarByClass(HW2Q2V3.class);
